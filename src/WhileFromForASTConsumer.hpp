...
class WhileFromForASTVisitor : public RecursiveASTVisitor<WhileFromForASTVisitor>, public Helpers {
public:
  // Inicijalizacija prepisivaca i konteksta
  WhileFromForASTVisitor(Rewriter &R, ASTContext &A)
    : Helpers(R, A)
    {}
...
class WhileFromForASTConsumer : public ASTConsumer {
public:
  // Konstruktor inicijalizuje posetioca
  // prepisivacem i kontekstom parsiranja
  WhileFromForASTConsumer(Rewriter &R, ASTContext &A)
    : Visitor(R, A) {}
...
private:
  ...
  WhileFromForASTVisitor Visitor;
};
