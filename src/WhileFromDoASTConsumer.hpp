#ifndef __WHILEDO_AST__
#define __WHILEDO_AST__ 1
...
class WhileFromDoASTVisitor : public RecursiveASTVisitor<WhileFromDoASTVisitor>, public Helpers {
public:
  // Inicijalizacija prepisivaca i konteksta
  WhileFromDoASTVisitor(Rewriter &R, ASTContext &A)
    : Helpers(R, A)
    {}
...
class WhileFromDoASTConsumer : public ASTConsumer {
public:
  // Konstruktor inicijalizuje posetioca
  // prepisivacem i kontekstom parsiranja
  WhileFromDoASTConsumer(Rewriter &R, ASTContext &A)
    : Visitor(R, A) {}
